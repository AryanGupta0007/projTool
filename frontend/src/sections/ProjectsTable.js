            ...
            <div className={"projects-table"}>
              ...
              <span
                  className="w-[68px] block text-center py-1 border border-green-500 text-green-600 rounded text-xs">Active</span>
                            ...
                            <td className="p-4">
                                <svg className="w-[18px] h-4 inline mr-1" viewBox="0 0 14 13" fill="none"
                                ...
                                <svg className="w-[18px] h-4 inline" viewBox="0 0 14 13" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M7 0L9.4687 3.60213L13.6574 4.83688L10.9944 8.29787L11.1145 12.6631L7 11.2L2.8855 12.6631L3.00556 8.29787L0.342604 4.83688L4.5313 3.60213L7 0Z"
                                        fill="#facc15"/>
                            ...
                            <td className="p-4">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     className="w-5 h-5 cursor-pointer fill-gray-500 rotate-90" viewBox="0 0 24 24">
              ...
              <span
                  className="w-[68px] block text-center py-1 border border-yellow-500 text-yellow-600 rounded text-xs">Pending</span>
                            ...
                            <td className="p-4 text-sm text-gray-800">
                                <div className="flex items-center cursor-pointer">
                                    <img src='https://readymadeui.com/profile_5.webp'
                                         className="w-7 h-7 rounded-full shrink-0"/>
                                    <div className="ml-4">
