            ...
            <div className="overflow-x-auto font-[sans-serif]">
                <table className="min-w-full bg-white">
                    ...
                    <tr className="hover:bg-gray-50">
                        ...
                        <td className="text-center p-4 text-xs">
                            <div className="mx-auto px-3 py-1 bg-yellow-500 w-max text-white rounded">Normal</div>
                        </td>
                        <td className="text-center p-4 text-xs">
                            <div className="mx-auto px-3 py-1 bg-yellow-500 w-max text-white rounded">In Progress</div>
                        </td>
                        <td className="text-center p-4 flex items-center">
                            <div className="bg-gray-300 rounded-full w-full h-2 min-w-[50px]">
                    ...
                    <tr className="hover:bg-gray-50">
                        ...
                        <td className="text-center p-4 text-xs">
                            <div className="mx-auto px-3 py-1 bg-green-500 w-max text-white rounded">Low</div>
                        </td>
                        <td className="text-center p-4 text-xs">
                            <div className="mx-auto px-3 py-1 bg-green-500 w-max text-white rounded">Done</div>
                        </td>
                    ...
                    <tr className="hover:bg-gray-50">
                        ...
                        <td className="text-center p-4 text-xs">
                            <div className="mx-auto px-3 py-1 bg-red-500 w-max text-white rounded">Cancel</div>
                        </td>
                        <td className="text-center p-4 flex items-center">
                            <div className="bg-gray-300 rounded-full w-full h-2 min-w-[50px]">
                                <div className="w-1/5 h-full rounded-full bg-purple-800"></div>
                ...
                <div className="md:flex m-4">
                    ...
                    <div className="flex items-center max-md:mt-4">
                        ...
                        <div className="border flex rounded divide-x-2 border-gray-400 divide-gray-400 overflow-hidden">
                            <button type="button" className="px-4 py-2 hover:bg-gray-100 text-sm">Previous</button>
                            <button type="button" className="px-4 py-2 hover:bg-gray-100 text-sm">Next</button>
                        </div>
                    </div>
                </div>
            </div>
