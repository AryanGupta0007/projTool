                    ...
                    <div className="border-b border-gray-900/10 pb-12">
                        ...
                        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <div className="mt-2">
                                    <input type="date" name="project-start-date" id="start-date" autoComplete="off"
                                           value={formState["project-start-date"]} onChange={onChange}
                                           className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"/>
                                </div>
                            </div>
                            <div className="sm:col-span-3">
                                ...
                                <div className="mt-2">
                                    <input type="date" name="project-end-date" id="end-date" autoComplete="off"
                                           value={formState["project-end-date"]} onChange={onChange}
                                           className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"/>
                                </div>
                            </div>
                            <div className="sm:col-span-3">
