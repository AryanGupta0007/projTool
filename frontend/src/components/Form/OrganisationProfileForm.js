...
export const OrganisationProfileForm = (props) => {
    const {profileFormState, updateProfileFormState, addOrganisationProfile} = useContext(FormContext)
                            ...
                            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                <div className="sm:col-span-3">
                                    <label htmlFor="full-name" className="block text-sm/6 font-medium text-gray-900">Organisation
                                        name</label>
                                    <div className="mt-2">
                                        <input type="text" name="org-name" id="full-name" onChange={onChange}
                                               autoComplete="given-name" value={profileFormState["org-name"]} required
                                               className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"/>
                                    </div>
                                </div>
                                <div className="sm:col-span-3">
                                    ...
                                    <div className="mt-2 grid grid-cols-1">
                                        <select id="industry" name="org-industry" autoComplete="industry-name"
                                                onChange={onChange} value={profileFormState["org-industry"]} required
                                ...
                                <div className="sm:col-span-4">
                                    <label htmlFor="email" className="block text-sm/6 font-medium text-gray-900">Email
                                        address</label>
                                    <div className="mt-2">
                                        <input id="email" name="org-email" type="email" onChange={onChange}
                                               autoComplete="email"
                                ...
                                <div className="col-span-full">
                                    ...
                                    <div className="mt-2">
                                    <textarea name="org-about" id="about" rows="3" onChange={onChange}
                                              value={profileFormState["org-about"]} required
                                ...
                                <div className="col-span-full">
                                    ...
                                    <div className="mt-2">
                                        <input type="text" name="org-address" id="street-address" onChange={onChange}
                                               value={profileFormState["org-address"]}
                                ...
                                <div className="sm:col-span-3">
                                    ...
                                    <div className="mt-2 grid grid-cols-1">
                                        <select id="industry" name="org-country" autoComplete="industry-name"
                                                onChange={onChange} value={profileFormState["org-country"]} required
                                                className="col-start-1 row-start-1 w-full appearance-none rounded-md bg-white py-1.5 pl-3 pr-8 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                                            {<option>INDIA</option>}
                                            {<option>USA</option>}
                                ...
                                <div className="sm:col-span-2">
                                    ...
                                    <div className="mt-2">
                                        <input type="text" name="org-number" id="phone-number"
                                               ...
                                               value={profileFormState["org-number"]} required
                                               className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                                               required/>
                                    </div>
                                </div>
                                <div className="sm:col-span-2">
                                    <label htmlFor="postal-code" className="block text-sm/6 font-medium text-gray-900">ZIP
                                        ...
                                        code</label>
                                    <div className="mt-2">
                                        <input type="text" name="org-pincode" onChange={onChange} id="postal-code"
                                               required
                                               autoComplete="postal-code" value={profileFormState["org-pincode"]}
                                               className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"/>
                                    </div>
                                </div>
                            </div>
