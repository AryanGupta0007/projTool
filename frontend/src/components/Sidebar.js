...
export const Sidebar = () => {
    return (
        <>
            ...
            <nav
                className="bg-white h-screen fixed top-0 left-0 min-w-[250px] py-6 px-4 font-[sans-serif] tracking-wide overflow-auto">
                <div className="flex flex-wrap items-center gap-4 cursor-pointer">
                    <img src='https://readymadeui.com/profile.webp'
                         className="w-10 h-10 rounded-full border-2 border-white"/>
                    <div>
                        <p className="txt-sm text-black">John Doe</p>
                        <p className="text-xs text-black-300 mt-0.5">johndoe23@gmail.com</p>
                    </div>
                </div>
                ...
                <ul className="space-y-3">
                    <li>
                        <Link to="javascript:void(0)"
                           className="text-black text-sm flex items-center hover:bg-gray-700 rounded px-4 py-3 transition-all">
                    ...
                    <li>
                        <Link to="javascript:void(0)"
                           className="text-black text-sm flex items-center hover:bg-gray-700 rounded px-4 py-3 transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                 className="w-[18px] h-[18px] mr-4" viewBox="0 0 16 16">
                                <path
